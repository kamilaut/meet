...
const credentials = {
  ...
  redirect_uris: ["https://kamilaut.github.io/meet/"],
  javascript_origins: ["https://kamilaut.github.io", "http://localhost:3000"],
};
...
module.exports.getCalendarEvents = async (event) => {
  ...
  //Decode authorization code extracted from URI query
